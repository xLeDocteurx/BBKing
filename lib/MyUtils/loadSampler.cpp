...
bool loadSampler(
    ...
    bool isLooping, float loopStartPosition, float loopEndPosition, float attackPosition, float decayPosition, float sustainPosition, float releasePosition)
{
    ...
    *instrumentPointer = {SAMPLER, isSolo, isMuted, false, volume, 0, pitch, 0, fileBufferPointer, 0, sample, isLooping, loopStartPosition, loopEndPosition, attackPosition, 0, decayPosition, 0, sustainPosition, 0, releasePosition, 0};
    return true;
}
